...
- **Production lane:** always read `references/production-lane.md`, which holds this file's "Production lane:" sections; for a new game or major rebuild, also read `references/studio-workflow.md` and `references/verification.md`; for any other Build/change, a Repair or a review, also read `references/verification.md`.
...
Read "Bind the vertical-slice brief" in `references/production-lane.md`.

## Production lane: build the game in passes

Read "Build the game in passes" in `references/production-lane.md`.
...
Read "Author the world and delivery pipeline" in `references/production-lane.md`.
...
Read "Verify the rendered product" in `references/production-lane.md`.
